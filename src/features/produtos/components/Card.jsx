    ...
    >
      <Link to={`/produto/${produto.id}`}>
        <div className="flex justify-center">
          <img src={img} alt={nome} className="h-40 object-contain" />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-700 line-clamp-3">{descricao}</p>

          <p className="text-2xl font-bold text-green-600">R$ {preco}</p>
        </div>
      </Link>
